...
if [ "$BASIC" = true ] ; then
    pip install imageio imageio-ffmpeg tqdm easydict opencv-python-headless ninja trimesh transformers==4.56.0 gradio==6.0.1 tensorboard pandas lpips zstandard
